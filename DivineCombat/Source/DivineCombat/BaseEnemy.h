...
protected:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Target Priority") // change where visable
	bool bIsWeakAgainst;
	...
	UFUNCTION(BlueprintPure, Category = "Target Priority")
	int32 DamageDealt(int Damage, int PlayerDefense);
	...
	UFUNCTION(BlueprintCallable, Category = "Target Priority")
	void WeaponTriangle(int WeaponAdvantage);
